...
Seguro.prototype.cotizarSeguro = function(){
	...
	//Cada año de diferencia es mayor, el costo va a 
	//reducirse un 3%

	cantidad -= ((diferencia *3) * cantidad)/ 100;

	/*
		Si el seguro es basico aumentar un 30%
		Si es completo entonces se aumentara un 50%
	*/
...
//Muestra de alertas en pantalla
UI.prototype.mostrarMensaje = (mensaje, tipo) =>{
	...
	//Para que se quite el mensaje de error en 3 segundos
	setTimeout(() =>{
		div.remove();
	}, 3000);
}
...
function cotizarSeguro(e){
	...
	//Leer el tipo de cobertura Forma de seleccionar un radioButtom
